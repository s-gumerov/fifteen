...
export const Router = () => {
  ...
  return (
    <Routes>
      ...
      <Route element={<PrivateRoute/>}>
        <Route path={ROUTES.GAME_FIELD}
               element={<MainLayout backUrl={ROUTES.MAIN}><GameFieldPageWithAudio/></MainLayout>}/>
      </Route>
      <Route element={<PrivateRoute/>}>
      ...
      <Route element={<PrivateRoute/>}>
        <Route path={ROUTES.EDIT_PROFILE}
               element={<MainLayout backUrl={ROUTES.PROFILE}><EditProfilePage/></MainLayout>}/>
      </Route>
      <Route element={<PrivateRoute/>}>
