      ...
      >
        <Form>
          ...
          <div className="profile__form">
            <TextFieldProfile fullWidth name="oldPassword" type="password" label="Старый пароль"/>
            <TextFieldProfile fullWidth name="newPassword" type="password" label="Новый пароль"/>
            <TextFieldProfile fullWidth name="password_again" type="password"
                              label="Повторите новый пароль"/>
            <Button variant="contained" size="large" type="submit" sx={{mt: 4}}>Сохранить</Button>
          </div>
        </Form>
      </Formik>
    </div>
