  ...
  return (
    <div className={styles.container} id={id}>
      <div className={styles.topic}>
        ...
        <div className={styles.topic__description}>{description}</div>
      ...
      <div className={styles.topic__lastMessage}>
        <span className={styles.username}>{last_message.author}</span>

        <span className={styles.date}>{last_message.date}</span>
      </div>
    </div>
  )
}
